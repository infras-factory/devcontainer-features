...
echo -e "${PURPLE}========================================${NC}"
echo -e "${PURPLE}     OH MY ZSH FEATURE TESTS (DEBIAN)${NC}"
echo -e "${PURPLE}========================================${NC}"
...
check "scripts directory exists" test -d "/usr/local/share/ohmyzsh/scripts"
check "configs directory exists" test -d "/usr/local/share/ohmyzsh/configs"
check "post-create script exists" test -f "/usr/local/share/ohmyzsh/scripts/post-create.sh"
check "post-start script exists" test -f "/usr/local/share/ohmyzsh/scripts/post-start.sh"
check "p10k config in system dir" test -f "/usr/local/share/ohmyzsh/configs/.p10k.zsh"
...
check "post-create script executable" test -x "/usr/local/share/ohmyzsh/scripts/post-create.sh"
check "post-start script executable" test -x "/usr/local/share/ohmyzsh/scripts/post-start.sh"
